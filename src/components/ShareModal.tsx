    ...
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <div className="bg-slate-950 border border-slate-800 rounded-lg shadow-xl max-w-sm w-full">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800">
          <h2 className="text-lg font-semibold text-slate-100">Share Analysis Results</h2>
          <button
        ...
        <div className="px-6 py-4 space-y-4">
          {/* Preview */}
          <div className="bg-slate-900 border border-slate-800 rounded p-3 text-xs text-slate-300 max-h-20 overflow-y-auto">
            {shareText}
          </div>
          ...
          <div className="space-y-2">
            ...
            <button
              onClick={handleCopy}
              className="w-full flex items-center gap-3 px-4 py-3 bg-slate-800 hover:bg-slate-700 rounded text-slate-100 transition-colors"
            >
              <Copy className="h-4 w-4" />
              <div className="text-left">
                <div className="text-sm font-medium">{copied ? 'Copied!' : 'Copy to Clipboard'}</div>
                <div className="text-xs text-slate-400">Quick copy of analysis summary</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-slate-400">Send to colleagues</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-slate-400">Post to your feed</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-slate-400">Reach your network</div>
              </div>
            </button>
          </div>
